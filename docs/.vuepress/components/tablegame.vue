...
#table {
  ...
  height: 544px;
  background: url(/image/img/table.gif) no-repeat
}
...
.guide {
  z-index: 3;
  _background: none;
  _filter: progid: DXImageTransform.Microsoft.AlphaImageLoader(enabled='true', sizingMethod='scale', src="/image/img/dashed_ball.png");
...
.target {
  left: 500px;
  top: 250px;
  background-image: url(/image/img/yellow_ball.png);
  _background: none;
  _filter: progid: DXImageTransform.Microsoft.AlphaImageLoader(enabled='true', sizingMethod='scale', src="/image/img/yellow_ball.png");
  background-repeat: no-repeat
}

.cue {
  background-image: url(/image/img/white_ball.png);
  _background: none;
  _filter: progid: DXImageTransform.Microsoft.AlphaImageLoader(enabled='true', sizingMethod='scale', src="/image/img/white_ball.png");
  background-repeat: no-repeat
}
